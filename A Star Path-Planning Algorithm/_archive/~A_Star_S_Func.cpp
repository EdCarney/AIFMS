 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Mon May 27 21:44:42 2019
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME A_Star_S_Func
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS            5
/* Input Port  0 */
#define IN_PORT_0_NAME        edges
#define INPUT_0_WIDTH         1
#define INPUT_DIMS_0_COL      10000000
...
/* Input Port  1 */
#define IN_PORT_1_NAME        nodes
#define INPUT_1_WIDTH         1
#define INPUT_DIMS_1_COL      10000000
...
/* Input Port  2 */
#define IN_PORT_2_NAME        numNodes
...
/* Input Port  3 */
#define IN_PORT_3_NAME        numEdges
...
/* Input Port  4 */
#define IN_PORT_4_NAME        startNode
...
#define OUTPUT_DIMS_0_COL     10000000
...
extern void A_Star_S_Func_Outputs_wrapper(const real_T *edges,
			const real_T *nodes,
...
{
    const real_T *edges = (real_T *) ssGetInputPortRealSignal(S, 0);
    const real_T *nodes = (real_T *) ssGetInputPortRealSignal(S, 1);
    const real_T *numNodes = (real_T *) ssGetInputPortRealSignal(S, 2);
    const real_T *numEdges = (real_T *) ssGetInputPortRealSignal(S, 3);
    const real_T *startNode = (real_T *) ssGetInputPortRealSignal(S, 4);
    real_T *finalPath = (real_T *) ssGetOutputPortRealSignal(S, 0);

    A_Star_S_Func_Outputs_wrapper(edges, nodes, numNodes, numEdges, startNode, finalPath);
