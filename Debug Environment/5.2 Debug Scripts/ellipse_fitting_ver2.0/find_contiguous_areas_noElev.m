function [blob_coord, blob_numpixels, crash_pts, flag] = find_contiguous_areas_noElev(img, LS_USA, min_border_pix, x_earth, y_earth, imin, jmin, deg2met, FGIF_p45, high_pop)
