function [ ra_safe,rb_safe,ang,centroid_safe ] = grow_ellipse_noElev( endpts, endpts_tot, bin_image, oob_color, rb_init, dbl_ended_growth, concurrent_growth, FGIF_p )
